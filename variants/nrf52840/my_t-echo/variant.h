...
#define SX126X_RXEN (0 + 2) // GPIO2 (P0.02) - RX enable control for RF switch
#define SX126X_TXEN RADIOLIB_NC // TXEN connected to DIO2 internally for automatic RF switching
...
// Note DIO3 is used as an *output* from the sx1262 and connected internally to power the tcxo, do not drive from the main CPU
